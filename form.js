class Form {
    ...
    constructor() {
        ...
        this.question2 = createElement('h3', "Q2. Do you think that the teachers should teach children with practicals?");
        this.radio1 = createRadio('h3');
        this.radio1.option('yes');
        this.radio1.option('No');
        this.question3 = createElement('h3', "Q3.Do you like coming to school in a school bus?");
